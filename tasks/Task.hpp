...
#ifndef PTU_DIRECTEDPERCEPTION_DIRECTEDPERCEPTIONTASK_TASK_HPP
#define PTU_DIRECTEDPERCEPTION_DIRECTEDPERCEPTIONTASK_TASK_HPP
...
namespace ptu_directedperception {
    ...
    protected:
        ...
        /* Handler for the ptFromRBS operation
         */
        virtual ::base::Vector2d ptFromRBS(::base::samples::RigidBodyState const & rbs_in);
